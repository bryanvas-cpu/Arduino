...
void processCommand(const String &command) {
  ...
  for (int i = 0; i < num_servos; i++) {
    int target_position = positions_cmd[i]*4095/6.28318; // Convert degrees to SCServo range
    if(i<6)
      target_position = 2.0944*4095/6.28318-target_position;
    else if(i<12)
      target_position = 0.785398*4095/6.28318+target_position;
    else if(i<18)
      target_position = 0.261799*4095/6.28318+target_position;
